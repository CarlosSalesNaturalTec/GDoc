...
Capability nova. Implementa o Épico 2 / **US 2.2** do PRD (`docs/prd_final.md`).
Nesta fatia a checagem de permissão de renomear/substituir é baseada em **dono**;
a permissão granular de "renomear/substituir" concedida a terceiros é o Épico 4.
