...
Depois de entrar, você pode trocar sua senha quando quiser em
[Minha conta](colaborador/minha-conta.md).

## Sair

Clique no seu perfil no canto superior direito e escolha **Sair**.
