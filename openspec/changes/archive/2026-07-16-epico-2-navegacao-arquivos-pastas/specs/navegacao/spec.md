...
Capability nova. Implementa o Épico 2 / **US 2.1** do PRD (`docs/prd_final.md`),
na fatia **só-por-dono**: a metade "itens que criei" do cenário 2 é vinculante
...
cenários Given/When/Then da US são vinculantes; os requisitos abaixo os tornam
