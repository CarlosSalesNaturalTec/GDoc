...
Capability existente. Esta mudança acrescenta o **vencimento** como condição do
ramo de grant na resolução de acesso, implementando o corte automático da
**US 4.3**, cenário 2 do PRD (`docs/prd_final.md`). O corte é um predicado de
consulta, não efeito de rotina agendada — ver design.md D1. Os ramos de posse e
de administração da unidade permanecem inalterados: eles não têm prazo.
