# web-painel — Delta Spec

Painel gerencial na SPA (Fatia 10 do roadmap de frontend): a página
`/admin/painel` consome `GET /dashboard` (capability `painel`, já arquivada) e
...
alcance imposto pelo servidor. Cobre o lado de frontend da **US 8.2**
(`docs/prd_final.md`, RF #14). Os critérios Dado/Quando/Então da US são
vinculantes; os cenários abaixo os detalham para a SPA.
