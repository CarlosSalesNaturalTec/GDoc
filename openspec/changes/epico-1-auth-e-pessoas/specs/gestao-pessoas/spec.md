# Spec — gestao-pessoas (delta)

Capability nova. Implementa o Épico 1 / **US 1.1** e o papel de administração da
**US 5.1** (alcance por unidade) do PRD (`docs/prd_final.md`). Os cenários
Given/When/Then dessas US são vinculantes; os requisitos abaixo os tornam
